...
func queriesSubscription() map[string]string {
	return map[string]string{
		createSubscription: "INSERT INTO subscriptions (course_id, matrix_id, user_id, expires_at) VALUES ($1, $2, $3, $4) RETURNING *",
		...
		updateSubscription: "UPDATE subscriptions SET user_id = $1, course_id = $2, matrix_id = $3, expires_at = $4 WHERE id = $5 RETURNING *",
	}
}
